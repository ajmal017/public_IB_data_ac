...
class TestApp(TestWrapper, TestClient):
    ...
    def chooseStocksHelper(self, ticker, undContract):
        ...
        self.minEpochs[ticker] = getLatestEpoch(self.postgresCursor, ticker, "bars_5_sec")
    ...
    def historicalDataRequests_req(self, numDays=365):
        ...
        for m in self.dataIds:
            ...
            self.reqHistoricalData(m, self.underlyingContract[m], "", durationSec(14400), sizeSec(10), "MIDPOINT", 1, 1, False, [])
    ...
    def historicalData(self, reqId: int, bar: BarData):
        ...
        if epoch > self.minEpochs[ticker]:
            insertOneBar(self.postgresConnection, bar, epoch, ticker, whichTable="bars_5_sec")
